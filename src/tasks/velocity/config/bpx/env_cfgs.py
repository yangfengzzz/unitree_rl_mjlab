"""Black Panther X velocity environment configurations."""
...
from src.assets.robots import get_bpx_robot_cfg
from src.tasks.velocity.velocity_env_cfg import make_velocity_env_cfg

TerrainType = Literal["rough", "obstacles"]


def bpx_rough_env_cfg(
  play: bool = False,
) -> ManagerBasedRlEnvCfg:
  """Create Black Panther X rough terrain velocity configuration."""
  ...
  # Set raycast sensor frame to BPX torso.
  ...
  cfg.rewards["pose"].params["std_standing"] = {
    r".*[fh][lr]_hip_roll_joint.*": 0.05,
    r".*[fh][lr]_hip_pitch_joint.*": 0.1,
    r".*[fh][lr]_knee_joint.*": 0.15,
  }
  cfg.rewards["pose"].params["std_walking"] = {
    r".*[fh][lr]_hip_roll_joint.*": 0.15,
    r".*[fh][lr]_hip_pitch_joint.*": 0.35,
    r".*[fh][lr]_knee_joint.*": 0.5,
  }
...
def bpx_flat_env_cfg(play: bool = False) -> ManagerBasedRlEnvCfg:
  """Create Black Panther X flat terrain velocity configuration."""
  cfg = bpx_rough_env_cfg(play=play)
